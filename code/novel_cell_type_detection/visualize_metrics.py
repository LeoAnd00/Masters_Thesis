...
class VisualizeEnv():
    ...
    def LossCompBoxPlotVisualization(self, image_path: str=None):
        ...
        metrics['Method'][metrics['Method'] == "Model1"] = "Model1 | Centroid + CL Loss"
        metrics['Method'][metrics['Method'] == "Model1_CL"] = "Model1 | CL Loss"
        metrics['Method'][metrics['Method'] == "Model1_Centroid"] = "Model1 | Centroid Loss"
