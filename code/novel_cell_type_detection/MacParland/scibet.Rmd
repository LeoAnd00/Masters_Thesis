...
c_score <- conf_score_R(ref = train_data_X, query = test_data_X, null_expr = null, gene_num = 500)

# Train and predict
```
```{r}
c_score <- conf_score_R(ref = train_data_X, query = test_data_X, null_expr = test_data_X, gene_num = 500)
```
