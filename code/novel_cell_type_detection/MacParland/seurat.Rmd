...
for (fold in seq(1, 5)) {
  ...
  # Set predicted id to "Novel" if prediction score is lower than 0.5
  predictions$predicted.id <- ifelse(predictions$prediction.score.max < 0.5, "Novel", predictions$predicted.id)
