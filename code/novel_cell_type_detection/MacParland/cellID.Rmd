...
for (fold in seq(1, 5)) {
  ...
  pred_score <- apply(test_data_X_group_gs, 2, max)/max(apply(test_data_X_group_gs, 2, max))
  test_data_X_group_gs_prediction_signif <- ifelse(pred_score>=0.5, yes = test_data_X_group_gs_prediction, "Novel")
  ...
  # For detecting novel cell type
  pred_score <- apply(test_data_X_cell_gs, 2, max)/max(apply(test_data_X_cell_gs, 2, max))
  test_data_X_cell_gs_prediction_signif <- ifelse(pred_score>=0.5, yes = as.vector(test_data_X_cell_gs_prediction), "Novel")
