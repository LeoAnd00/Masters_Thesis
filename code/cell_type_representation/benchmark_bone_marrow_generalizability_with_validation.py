...
# Then:
# sbatch jobscript_generalizability_with_validation_bone_marrow.sh

def main(data_path: str, model_path: str, result_csv_path: str, pathway_path: str, gene2vec_path: str):
    """
    Execute the generalizability benchmark pipeline when using 20% of training dat for validation
    instead of the entire training data set for validation. Selects 4 samples for testing and uses the
    ...
    How to run example (on bone marrow data set): python benchmark_bone_marrow_generalizability_with_validation.py '../../data/processed/data_to_assess_generalisability/bone_marrow_human/Assess_generalisability_bone_marrow.h5ad' 'trained_models/Assess_generalisability/' 'benchmarks/results/Generalizability_with_validation/Benchmark_results' '../../data/processed/pathway_information/all_pathways.json' '../../data/raw/gene2vec_embeddings/gene2vec_dim_200_iter_9_w2v.txt'
    """
