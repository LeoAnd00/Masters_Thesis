    ...
    for train_num in num_patients_for_training_list:
        ...
        for seed in r_seeds:
            ...
            if model == 'Encoder':
                ...
                benchmark_env.make_benchamrk_results_dataframe(counter=counter, min_max_normalize=False)
...
if __name__ == "__main__":
    ...
    How to run example (on bone marrow data set): python benchmark_bone_marrow_generalizability.py '../../data/processed/data_to_assess_generalisability/bone_marrow_human/Assess_generalisability_bone_marrow.h5ad' 'Encoder' 'trained_models/Bone_marrow/' 'benchmarks/results/Generalizability/Benchmark_results' '../../data/processed/pathway_information/all_pathways.json' '../../data/raw/gene2vec_embeddings/gene2vec_dim_200_iter_9_w2v.txt' '_generalizability/'
    """
