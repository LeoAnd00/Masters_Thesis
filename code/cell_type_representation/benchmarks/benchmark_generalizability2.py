...
class benchmark():
    ...
    def in_house_model_encoder(self, save_path: str, umap_plot: bool=True, train: bool=True, save_figure: bool=False):
        ...
        adata_in_house = self.original_test_adata.copy()
    ...
    def in_house_model_itscr(self, save_path: str, umap_plot: bool=True, train: bool=True, save_figure: bool=False):
        ...
        self.in_house_ITSCR_model = scib.metrics.metrics(
            self.original_test_adata,
            adata_in_house,
            "batch", 
            self.label_key,
    ...
    def make_benchamrk_results_dataframe(self, counter: int, min_max_normalize: bool=False):
        """
        ...
        if self.metrics_in_house_model_pathways is not None:
            ...
            calculated_metrics_names.append(f"In-house Pathways Model {counter}")
        if self.metrics_in_house_model_encoder_pathways is not None:
            ...
            calculated_metrics_names.append(f"In-house HVG Encoder with Pathways Model {counter}")
        if self.metrics_in_house_model_transformer_encoder is not None:
            ...
            calculated_metrics_names.append(f"In-house HVG Transformer Encoder Model {counter}")
        if self.metrics_in_house_model_transformer_encoder_pathways is not None:
            ...
            calculated_metrics_names.append(f"In-house HVG Transformer Encoder with Pathways Model {counter}")
        if self.metrics_in_house_model_tokenized_HVG_transformer is not None:
            ...
            calculated_metrics_names.append(f"In-house Tokenized HVG Transformer Encoder Model {counter}")
