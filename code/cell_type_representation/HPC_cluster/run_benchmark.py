...
# python run_benchmark.py '../../../data/processed/immune_cells/merged/Oetjen_merged.h5ad' '../trained_models/Bone_marrow/' '../benchmarks/results/Bone_marrow/Test' '../../../data/processed/pathway_information/all_pathways.json' '../../../data/raw/gene2vec_embeddings/gene2vec_dim_200_iter_9_w2v.txt' ''
...
def main(data_path: str, model_path: str, result_csv_path: str, pathway_path: str, gene2vec_path: str, image_path: str):
    ...
    benchmark_env.in_house_model_encoder(save_path=f'{model_path}Encoder/', train=False, umap_plot=False, save_figure=True)

    print("**Start benchmarking In-house Pathways method**")
    benchmark_env.in_house_model_pathways(save_path=f'{model_path}Pathways/', train=False, umap_plot=False, save_figure=True)

    print("**Start benchmarking In-house Encoder with Pathways method**")
    benchmark_env.in_house_model_encoder_pathways(save_path=f'{model_path}Encoder_with_Pathways/', train=False, umap_plot=False, save_figure=True)

    print("**Start benchmarking In-house Transformer on HVGs method**")
    benchmark_env.in_house_model_transformer_encoder(save_path=f'{model_path}Transformer_Encoder/', train=False, umap_plot=False, save_figure=True)

    print("**Start benchmarking In-house Transformer on HVGs and Pathways method**")
    benchmark_env.in_house_model_transformer_encoder_pathways(save_path=f'{model_path}Transformer_Encoder_with_Pathways/', train=False, umap_plot=False, save_figure=True)
