...
class OutputEncoder(nn.Module):
    def __init__(self, 
        ...
        self.pathways_linear2 = nn.Linear(int(num_pathways/2), int(num_pathways/4)) # num_pathways
        ...
        #self.final_output = nn.Linear(int(output_dim*2), output_dim)
...
class CellType2VecModel(nn.Module):
    ...
    def __init__(self, 
        ...
        self.pathway_transformer = PathwayTransformer(mask=mask,
                                                        ...
                                                        mlp_ratio=4, 
                                                        attn_bias=attn_bias,
                                                        drop_ratio=0.2, # Changed from 0.2 to 0.5
                                                        attn_drop_out=0., # Changed from 0. to 0.5
                                                        depth=3,
                                                        act_layer=nn.ReLU,
                                                        norm_layer=nn.LayerNorm)
