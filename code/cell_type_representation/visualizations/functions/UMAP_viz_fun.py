...
class UMAP_Kidney_Viz():
    """
    A class for visualizing the first fold of the kidney dataset for PCA and Model1.
    ...
    def Model1(self, save_path: str="trained_models/"):
        """
        Use of model1 on single-cell RNA-seq data.
    ...
    def umap_viz(self, save_path: str="trained_models/", image_path: str=None):
        ...
        adata_pca = self.pca()
        adata_model1 = self.Model1(save_path=save_path)
