            ...
            while True:  # Keep trying new seeds until no error occurs
                try:
                    ...
                    benchmark_env = benchmark(data_path=data_path, 
                                            ...
                                            HVGs=2000, 
                                            pct_for_testing=0.2,
                                            pct_for_training=list_of_data_pct[idx],#0.8,
                                            Scaled=False, 
                                            seed=42,
                    ...
                    #benchmark_env.in_house_model_itscr(save_path=f'{model_path}ITSCR/Generalizability2/train_num_{train_num}_seed_{seed}_', train=True, umap_plot=False, save_figure=False)
                    #benchmark_env.in_house_model_itscr_only_HVGs(save_path=f'{model_path}ITSCR_only_HVGs/Generalizability2/train_num_{train_num}_seed_{seed}_', train=True, umap_plot=False, save_figure=False)
