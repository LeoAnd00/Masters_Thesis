...
class PathwayTransformer(nn.Module):
    ...
    def __init__(self, 
        ...
        attn_embed_dim += 1 # To account for the class token
...
class CellType2VecModel(nn.Module):
    ...
    def forward(self, x, pathways, gene2vec_emb, return_attention=False):
        ...
        if return_attention:
            pathways, attn_matrix = self.pathway_transformer(pathways, return_attention) 
        else:
            pathways = self.pathway_transformer(pathways, return_attention) 
